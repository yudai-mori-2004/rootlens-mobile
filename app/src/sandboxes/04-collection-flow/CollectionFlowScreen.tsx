...
export default function CollectionFlowScreen() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        // Android で `requestCameraPermissionsAsync` が silent hang する事例を踏まえ、
        // 既に grant 済なら request を回避する。
        ...
        console.warn('[CollectionFlow] permission check failed', e);
